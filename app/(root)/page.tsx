  ...
  return (
    <main className="text-gray-900">
      <header className="flex h-60 justify-around items-center">
        <h1 className="text-3xl font-semibold">bytirzasantos</h1>
      ...
      <section className="flex flex-col items-center sm:px-[17%]">
        <div className="w-full  md:max-w-[750px] h-[50vh] max-h-[500px] md:min-h-[500px] bg-[url('/images/photo2.png')] bg-cover bg-center bg-no-repeat rounded"></div>
